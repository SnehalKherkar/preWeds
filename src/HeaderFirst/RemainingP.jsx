...
const RemainingP = () => {
  return (
    <div className="containe">
      {/* <div className="Name" style={{backgroundColor:"black"}}>
        <h1>
          {" "}
          <img
      ...
      <div className="second_images">
        <Carousel>
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <h3 style={{ color: "white" }}>
                Make Your Pre_wedding Dream Come True
              </h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            ...
            <Carousel.Caption>
              <h1>Make Your Pre_wedding Dream Come True</h1>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={atul11} alt="Third slide" />
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={atul12} alt="Third slide" />
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={atul10} alt="Third slide"  />
