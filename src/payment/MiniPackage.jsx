...
const MiniPackage = () => {
  ...
  let package_price = 12999;
  let serviceFee = 300;
  let booking_price = 4999;
  const [makeup_artist_package, set_makeup_artist_package] = useState(0);
  const [NumberOfPerson, setNumberOfPerson] = useState(8);
  const [payabelAmount, setPayabelAmount] = useState(package_price + serviceFee);
  const [RemainingAmount, setRemainingAmount] = useState(package_price - booking_price);
  ...
  const calc = () => {
    ...
    setPayabelAmount(package_price + serviceFee + numberOfPersonsAmount + makeup_artist_package)
  }
          ...
          <Row>
            <Col sm={8}>
              ...
              <div>
                ...
                <h6 style={{ marginLeft: "35px" }}>Half Day</h6>
                <hr />
              </div>
              ...
              <Tabs activeKey={activeTab} onSelect={handleTabSelect}>
                ...
                <Tab eventKey="tab2">
                  ...
                  <div>
                    ...
                    <h5>Rs.4999/-</h5>
                    <button className="information_btn" onClick={() => { 
                ...
                <form action="">
                  ...
                  <div>
                    <label htmlFor="" style={{ marginTop: "30px" }}>
                      Add extra Person (Till 8 person its free) ({NumberOfPerson})
                    </label>
                    <br />
                    <select onChange={(e) => {
                      setNumberOfPerson(e.target.value);
                      calc();
                    }} className="information_btn" name="extra" id="extra">
                      <option value="8" >
                  ...
                  <div>
                    ...
                    <br />
                    <select className="information_btn" name="extra" id="extra">
                      <option value="8Adults">9 AM to 2 PM</option>
                      <option value="9Adults">3 PM to 8 PM</option>
                    </select>
                  </div>
                  ...
                  <p>(Minimum ₹ 3,250 amount need to pay for booking.)</p>
                </form>
              </div>
            </Col>
          </Row>
